...
exports.requestManager = exports.cdeebee = exports.INITIAL_STORAGE = undefined;
...
var cdeebee = exports.cdeebee = function cdeebee() {
  ...
  switch (type) {
    ...
    case _constants.types.CDEEBEEE_UPDATE:
      return _extends({}, state, {
        requestByApiUrl: _extends({}, state.requestByApiUrl, (_extends2 = {}, _extends2[payload.api] = payload.cleanResponse, _extends2))
      });
    case _constants.types.CDEEBEE_ERRORHANDLER_SET:
      return _extends({}, state, {
        errorHandler: _extends({}, state.activeRequest, (_extends3 = {}, _extends3[payload.api] = payload.cleanResponse, _extends3))
      });

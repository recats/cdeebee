...
exports.default = function (_ref) {
  var api = _ref.api,
      ...
      _ref$responseCode = _ref.responseCode,
      responseCode = _ref$responseCode === undefined ? 'responseStatus' : _ref$responseCode;
  return function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(dispatch, getState) {
      var _Object$assign, nanoID, body, source, formData, i, resp, processID, response;

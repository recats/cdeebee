...
exports.default = function (_ref) {
  ...
  return function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(dispatch, getState) {
      var _Object$assign, body, nanoID, source, formData, i, resp, processID, _response;
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              body = JSON.stringify(_extends({}, data, { sessionToken: _jsCookie2.default.get('sessionToken') }));
            ...
            case 8:
              ...
              while (responsePosition[(0, _get2.default)(getState().requestManager.activeRequest, '[0].nanoID')]) {
                ...
                _response = responsePosition[processID];
                ...
                if (_response.errorCode === 0) {
                  ...
                  dispatch({
                    ...
                    payload: { response: normalize(_response), cleanResponse: _response, api: api }
                  });
                  ...
                  dispatch({
                    ...
                    payload: { api: api, response: _response }
                  });

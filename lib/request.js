        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _mergeDeepRight = (0, _ramda.mergeDeepRight)(_this.requestObject, rq), api = _mergeDeepRight.api, preUpdate = _mergeDeepRight.preUpdate, postUpdate = _mergeDeepRight.postUpdate, preError = _mergeDeepRight.preError, postError = _mergeDeepRight.postError, data = _mergeDeepRight.data, files = _mergeDeepRight.files, _mergeDeepRight$reque = _mergeDeepRight.requestCancel, requestCancel = _mergeDeepRight$reque === undefined ? true : _mergeDeepRight$reque, _mergeDeepRight$metho = _mergeDeepRight.method, method = _mergeDeepRight$metho === undefined ? _this.options.defaultMethod : _mergeDeepRight$metho, _mergeDeepRight$norma = _mergeDeepRight.normalize, normalize = _mergeDeepRight$norma === undefined ? _helpers.defaultNormalize : _mergeDeepRight$norma, _mergeDeepRight$merge = _mergeDeepRight.mergeStrategy, mergeStrategy = _mergeDeepRight$merge === undefined ? _constants.cdeebeeMergeStrategy.merge : _mergeDeepRight$merge, _mergeDeepRight$heade = _mergeDeepRight.headers, headers = _mergeDeepRight$heade === undefined ? _this.options.defaultHeader : _mergeDeepRight$heade, _mergeDeepRight$respo = _mergeDeepRight.responseKeyCode, responseKeyCode = _mergeDeepRight$respo === undefined ? _this.options.defaultResponseKeyCode : _mergeDeepRight$respo;
                _context.prev = 1;

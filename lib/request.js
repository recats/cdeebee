  ...
  this.send = function (rq) {
    return function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(dispatch, getState) {
        var _mergeDeepRight, api, preUpdate, postUpdate, preError, postError, data, files, _mergeDeepRight$reque, requestCancel, _mergeDeepRight$metho, method, _mergeDeepRight$norma, normalize, _mergeDeepRight$merge, mergeStrategy, _mergeDeepRight$heade, headers, _mergeDeepRight$respo, responseCode, nanoID, body, source, formData, i, resp, _Object$assign, processID, _responsePosition$pro, response, requestApi;
